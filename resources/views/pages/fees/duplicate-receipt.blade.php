...
<x-main-card>
    ...
    <div class="p-4 border my-10 flex justify-around">
        <div>
            ...
            <x-input type="text" placeholder="First Name" id='sname' name="name" />
        </div>
        <div>
...
<script>
    ...
    enableTransliteration($("input[name='name']")[0], 'kn')
    enableTransliteration($("#sname")[0], 'kn')
    enableTransliteration($("input[name='fname']")[0], 'kn')
    enableTransliteration($("input[name='lname']")[0], 'kn')
